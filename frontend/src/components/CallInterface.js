...
function CallInterface() {
  ...
  const submitCallLog = async (e) => {
    ...
    try {
      ...
      const callDuration = callStartTime ? Math.round((new Date() - callStartTime) / 1000) : null;
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <Card className="w-full max-w-md">
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-2">No leads available</h3>
              <p className="text-gray-500 mb-6">
                There are no more leads to call in this campaign.
              </p>
              <Button onClick={() => navigate('/campaigns')} className="btn-hover">
  ...
  return (
    <Layout title="Call Interface" subtitle="Campaign: Active Campaign" headerActions={headerActions}>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span>{currentLead.first_name} {currentLead.last_name}</span>
                  </CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  {campaignLead.last_call_outcome && (
                    <Badge className={getOutcomeColor(campaignLead.last_call_outcome)}>
              ...
              <CardContent className="space-y-6">
                ...
                {callStartTime && (
                  <div className="text-center text-sm text-gray-500 pt-4 border-t">
                    Call duration: {callStartTime ? Math.round((new Date() - callStartTime) / 1000) : 0}s
                  </div>
                )}
              </CardContent>
            </Card>
